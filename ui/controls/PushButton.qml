...
CustomTouchArea {
	...
	BorderImage {
		...
		source: pressed ? "qrc:/core/ui/images/push_button_down_70.png" : "qrc:/core/ui/images/push_button_normal_70.png"
		visible: dp <= 1.5
	}
	...
	BorderImage {
		...
		horizontalTileMode: BorderImage.Stretch
		verticalTileMode: BorderImage.Stretch
		source: pressed ? "qrc:/core/ui/images/push_button_down_140.png" : "qrc:/core/ui/images/push_button_normal_140.png"
		visible: dp > 1.5
	}
	...
	Image {
		...
		source: "qrc:/core/ui/images/push_button_led_off.png"
        visible: showLed
	}
	...
	Image {
		...
		anchors.bottom: parent.bottom
		anchors.bottomMargin: active ? 10*dp : 12*dp
		source: "qrc:/core/ui/images/push_button_led_blue.png"
	...
	Image {
		...
		anchors.bottom: parent.bottom
		anchors.bottomMargin: active ? 10*dp : 12*dp
		source: "qrc:/core/ui/images/push_button_led_yellow.png"
		opacity: active ? 1 : 0
		Behavior on opacity {
			NumberAnimation {
				duration: 300
