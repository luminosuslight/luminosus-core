...
Item {
    ...
    Image {
        width: 30*dp
        height: 30*dp
        source: dp <= 1 ? (node.focused ? "qrc:/core/ui/images/node_rect_red.png" : "qrc:/core/ui/images/node_rect_blue.png")
                        : (node.focused ? "qrc:/core/ui/images/node_rect_red@2x.png" : "qrc:/core/ui/images/node_rect_blue@2x.png")
    }
