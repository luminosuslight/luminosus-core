...
Item {
    ...
    Image {
        ...
        height: 30*dp
        x: -15*dp
        source: dp <= 1 ? (node.focused ? "qrc:/core/ui/images/node_rect_red.png" : "qrc:/core/ui/images/node_rect_" + (node.htpMode ? "cyan.png" : "blue.png"))
                        : (node.focused ? "qrc:/core/ui/images/node_rect_red@2x.png" : "qrc:/core/ui/images/node_rect_" + (node.htpMode ? "cyan@2x.png" : "blue@2x.png"))
    }
